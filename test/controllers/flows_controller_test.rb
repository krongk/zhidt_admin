...
class FlowsControllerTest < ActionController::TestCase
  ...
  test "should create flow" do
    assert_difference('Flow.count') do
      post :create, flow: { description: @flow.description, icon: @flow.icon, package_id: @flow.package_id, title: @flow.title, tutorial: @flow.tutorial }
    end
  ...
  test "should update flow" do
    patch :update, id: @flow, flow: { description: @flow.description, icon: @flow.icon, package_id: @flow.package_id, title: @flow.title, tutorial: @flow.tutorial }
    assert_redirected_to flow_path(assigns(:flow))
  end
