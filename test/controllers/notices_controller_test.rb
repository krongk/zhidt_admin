...
class NoticesControllerTest < ActionController::TestCase
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post :create, notice: { is_read: @notice.is_read, level: @notice.level, message: @notice.message, user_id: @notice.user_id }
    end
  ...
  test "should update notice" do
    patch :update, id: @notice, notice: { is_read: @notice.is_read, level: @notice.level, message: @notice.message, user_id: @notice.user_id }
    assert_redirected_to notice_path(assigns(:notice))
  end
